...
//                .andExpect(jsonPath("_links.update-event").exists())
                .andDo(document("create-event",
                        ...
                        requestFields(
                                ...
                                fieldWithPath("limitOfEnrollment").description("location of new event")
                        ),
                        responseHeaders(
    ...
    @Test
    @TestDescription("30개의 이밴트를 10개씩 두번째 페이지 조회하기")
    ...
    @Test
    @TestDescription("없는 이벤트는 조회했을 떄 404응답받기")
    ...
    public void updateEvent404() throws Exception {
        ...
        this.mockMvc.perform(put("/api/events/1123123")
                .contentType(MediaType.APPLICATION_JSON)
                .content(this.objectMapper.writeValueAsString(eventDto)))
                .andDo(print())
                .andExpect(status().isNotFound());
